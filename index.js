...
module.exports = postcss.plugin('postcss-px-to-viewport', function (options) {
    ...
    return function (css, result) {
        ...
        if (landscapeRules.length > 0) {
            var landscapeRoot;
            if (typeof postcss.AtRule === "function") landscapeRoot = new postcss.AtRule({
                params: '(orientation: landscape)', name: 'media'
            }); else if (typeof postcss.atRule === "function") landscapeRoot = new postcss.atRule({
                params: '(orientation: landscape)', name: 'media'
            }); else landscapeRoot = new postcss.atRule({params: '(orientation: landscape)', name: 'media'});
